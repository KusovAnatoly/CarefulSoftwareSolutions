...
namespace Messages.Desktop.UWP.Common
{
    public class RichTextBoxHelper : DependencyObject
    {
        ...
        public static readonly DependencyProperty PlainTextProperty =
          ...
          typeof(RichTextBoxHelper), new PropertyMetadata(null, OnPlainTextChanged));
          ...
          DependencyPropertyChangedEventArgs e)
        {
            ...
            switch (state)
            {
                case RichEditChangeState.Idle:
                    ...
                    source.Document.SetText(TextSetOptions.ApplyRtfDocumentDefaults, text);
                    break;
        ...
        private static readonly DependencyProperty RichEditChangeStateHelperProperty =
          ...
          typeof(RichEditChangeStateHelper), typeof(RichTextBoxHelper), null);
        ...
        private static void AttachRichEditBoxChangingHelper(DependencyObject o)
        {
            ...
            richEdit.TextChanged += (sender, args) =>
            {
                ...
                switch (state)
                {
                    case RichEditChangeState.Idle:
                        string text = null;
                        richEdit.Document.GetText(TextGetOptions.FormatRtf, out text);
